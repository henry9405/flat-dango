...
const movies = [
    {
        "films": [
          ...
          },
          {
            ...
            "showtime": "10:00PM",
            "tickets_sold": 44,
            "description": "Giant spiders from another dimension invade Wisconsin.",     "poster": "https://www.gstatic.com/tv/thumb/v22vodart/42171/p42171_v_v8_ab.jpg"
        },
        {
          "id": "11",
        ...
        },
        {
          ...
          "showtime": "09:00PM",
          "tickets_sold": 31,
          "description": "A stock car driver goes undercover as the wheel man for a motorcycle gang.",     "poster": "https://www.gstatic.com/tv/thumb/v22vodart/45367/p45367_v_v8_aa.jpg"
        },
        {
          "id": "14",
...
function displayMoviesDetails(movie) {
    ...
    title.textContent = movie.title; // Fixed the variable name typo (tittle -> title)
...
function populateMovieList(){
    ...
    films.forEach((movie) => {
        ...
        listItem.textContent = movie.title; // Fixed the variable name typo (tittle -> title)
